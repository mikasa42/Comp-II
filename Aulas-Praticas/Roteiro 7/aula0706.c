...
int main (int argc, char *argv [])
{
	...
	char *validacao;
	unsigned short numeroLinha, numeroColuna, linha, coluna, pontoLinha, pontoColuna;
	...
	variavelLonga = strtoul (argv [argc-3], &validacao, 10);  
	pontoLinha = variavelLonga;
	...
	variavelLonga = strtoul (argv [argc-2], &validacao, 10);  
	pontoColuna = variavelLonga;
	...
	variavelLonga = strtoul (argv [argc-1], &validacao, 10);  
...
*/
	...
	status = PreencherPoligono (matriz, linha,coluna,pontoLinha, pontoColuna,tempoEspera);
