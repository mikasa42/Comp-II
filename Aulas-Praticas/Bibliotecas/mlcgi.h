...
{
  /* 000 */ ML_CGI_OK,                                  
  /* 001 */ ML_CGI_FATAL_ERROR,
  /* 002 */ ML_CGI_MEMORY_ALLOCATION_ERROR,
  /* 003 */ ML_CGI_IO_ERROR,
  /* 004 */ ML_CGI_INVALID_CONTENT_LENGTH,
  /* 005 */ ML_CGI_INVALID_CONTENT_TYPE,
  /* 006 */ ML_CGI_INVALID_REQUEST_METHOD,
  /* 007 */ ML_CGI_FORM_FIELD_NOT_FOUND,
  /* 008 */ ML_CGI_INVALID_FORM_LENGTH,
  /* 009 */ ML_CGI_INVALID_COOKIE_NAME,
  /* 010 */ ML_CGI_INVALID_COOKIE_VALUE,
  /* 011 */ ML_CGI_INVALID_COOKIE_EXPIRATION,
  /* 012 */ ML_CGI_INVALID_COOKIE_PATH,
  /* 013 */ ML_CGI_INVALID_COOKIE_DOMAIN,
  /* 014 */ ML_CGI_INVALID_COOKIE_SECURITY,
  /* 015 */ ML_CGI_INVALID_COOKIE_NAME_LENGTH,
  /* 016 */ ML_CGI_COOKIE_NOT_FOUND,
  /* 017 */ ML_CGI_NO_COOKIES,
  /* 018 */ ML_CGI_INVALID_ENVIRONMENT_VARIABLE_NAME,
  /* 019 */ ML_CGI_INVALID_COOKIE_DIRECTORY,
  /* 020 */ ML_CGI_INVALID_NICKNAME,
  /* 020 */ ML_CGI_INVALID_COOKIE
} mlCgiErrorConstants;
